...
namespace BuilderTestSample.Tests
{
    public class OrderServiceValidateAddress
    {
        ...
        [Fact]
        public void ThrowsExceptionGivenNoPostalCode()
        {
            Address tester = new AddressBuilder().WithTestValues().WithPostalCode(null).Build();
        ...
        [Fact]
        public void ThrowsExceptionGivenNoCountry()
        {
            Address tester = new AddressBuilder().WithTestValues().WithCountry(null).Build();
